				...
				switch (gfxindextype)
				{
					case PHY_INTEGER:
					{
						for (gfxindex = 0; gfxindex < numtriangles; gfxindex++)
						{
							...
							triangle[0].setValue((btScalar)graphicsbase[0] * meshScaling.x, (btScalar)graphicsbase[1] * meshScaling.y, (btScalar)graphicsbase[2] * meshScaling.z);
							graphicsbase = (double*)(vertexbase + tri_indices[1] * stride);
							triangle[1].setValue((btScalar)graphicsbase[0] * meshScaling.x, (btScalar)graphicsbase[1] * meshScaling.y, (btScalar)graphicsbase[2] * meshScaling.z);
							graphicsbase = (double*)(vertexbase + tri_indices[2] * stride);
							triangle[2].setValue((btScalar)graphicsbase[0] * meshScaling.x, (btScalar)graphicsbase[1] * meshScaling.y, (btScalar)graphicsbase[2] * meshScaling.z);
							callback->internalProcessTriangleIndex(triangle, part, gfxindex);
						}
						break;
					}
				...
				case PHY_FLOAT:
				{
					...
					if (numverts)
					{
						...
						for (int i = 0; i < numverts; i++)
						{
							...
							tmpVertices[i].x = graphicsbase[0];
							tmpVertices[i].y = graphicsbase[1];
							tmpVertices[i].z = graphicsbase[2];
						}
