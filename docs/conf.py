...
html_logo = '../tools/level_editor/resources/icons/crown-black-socket.svg'

html_favicon = '../tools/level_editor/resources/icons/crown-black-socket.svg'
