...
The init() function is called right after the runtime starts. I can be used to
...
In the boot script you will typically define the global entry points we
...
is for consistency with how resources are referenced elsewhere.
...
on top of the basic init/shutdown/update/render hooks we discussed earlier.
