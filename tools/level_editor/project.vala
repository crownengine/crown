...
public class Project
{
	...
	public void create_initial_files(string source_dir)
	{
		...
		// Write main.lua
		{
			string text = "require \"core/game/camera\""
				...
				+ "\n	local camera_transform = SceneGraph.instance(Game.sg, camera_unit)"
				+ "\n	SceneGraph.set_local_position(Game.sg, camera_transform, Vector3(0, 6.5, -30))"
	...
	public void create_components(Database db, Guid parent_unit_id, Guid unit_id, string material_name, string resource_name, string node_name, Hashtable node)
	{
