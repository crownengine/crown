...
#define RESOURCE_VERSION_UNIT             RESOURCE_VERSION(24)
#define RESOURCE_VERSION_LEVEL            (RESOURCE_VERSION_UNIT + 6) //!< Level embeds UnitResource
#define RESOURCE_VERSION_MATERIAL         RESOURCE_VERSION(9)
...
#define RESOURCE_VERSION_RENDER_CONFIG    RESOURCE_VERSION(5)
